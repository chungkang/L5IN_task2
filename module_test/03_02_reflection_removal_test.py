# -*- coding: utf-8 -*-
"""
Created on Wed May 26 17:08:03 2021
...
img = cv2.imread('module_test\\result\\image2.jpg')
...
cv2.imwrite('module_test\\result\\hist_eq_img.jpg', hist_eq_img)
cv2.imwrite('module_test\\result\\CLAHE_img.jpg', CLAHE_img)
