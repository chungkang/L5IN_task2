# -*- coding: utf-8 -*-
"""
Created on Sun Feb  7 15:02:22 2021
...
def image_n8 (datapath,imagename):
    
    bin_image_file = '%s/Binaer/%s_binaer.txt' % (datapath,imagename)
    ...
    N8_file = '%s/N8/%s_n8.txt' % (datapath,imagename)#save binary code
